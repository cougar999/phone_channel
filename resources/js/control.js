...
CJS.downloadScript = function(url) {
	...
	if ( CJS.bIE || CJS.bOpera || CJS.bChrome ) {
...
//	CJS.bIE && (src += src.indexOf('?')==-1?'?':'&'+Math.random());
...
CJS.init = function() {
	...
	CJS.bChrome = ( -1 != navigator.userAgent.indexOf('Chrome/') || -1 != navigator.userAgent.indexOf('Safari') );
