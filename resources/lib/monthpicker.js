...
//            value: new Date().getMonth() + 1
            value:  parseDate(GetDateStr(-1)).format("M")
        },
        quarter: {
            key: 'quarter',
            type: 'button',
...
//				$body.append('<th class="caption">' + tpl.caption + '</th>').append(jQuery("<td></td>").append($list));
				$body.append(jQuery("<td></td>").append($list)).append('<th class="caption">' + tpl.caption + '</th>');
...
//				$body.append('<th class="caption">' + tpl.caption + '</th>').append($items);
				$body.append('<th class="caption"></th>').append($items);
