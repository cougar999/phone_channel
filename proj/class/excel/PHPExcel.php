...
class PHPExcel
{
	...
	/**
	* Add by wilson,2010/07/19,leyou.com
	* zip archive load object.
	*/
	public $_template_zip_object = null;

	public function getZipObject()
	{
		return $this->_template_zip_object;
	}	
	public function setZipObject($zip_object)
	{
		$this->_template_zip_object = $zip_object;
	}	
